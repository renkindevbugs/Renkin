...
fun ApplicationItem(app: PackageInfoStruct) {
    ...
    Row(modifier = Modifier.fillMaxWidth(),
        ...
        Image(painter = BitmapPainter(app.genIcon.scale(198, 198).asImageBitmap()), contentDescription = null)
    ...
    if (openAppOptions) {
        AppOptions(app) { openAppOptions = false }
    }
}

@Composable
fun CreateButton(apps: Array<PackageInfoStruct>) {
...
@Composable
fun CreatePackButton(apps: Array<PackageInfoStruct>) {
    val ctx = getCurrentContext()
